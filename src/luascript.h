...
public:
	...
	static int32_t getItemIdByName(lua_State* L);
	static int32_t setPlayerIdGhostMode(lua_State* L);
	static int32_t isPlayerIdGhost(lua_State* L);
	static int32_t getPlayerIdLastGhostTime(lua_State* L);
	//CAST SYSTEM END
